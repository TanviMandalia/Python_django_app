...
urlpatterns = [
    ...
    path('super-admin/subscriptions/confirm/<int:payment_id>/', views.super_admin_confirm_sub_payment, name='super_admin_confirm_sub_payment'),
    path('super-admin/subscriptions/reject/<int:payment_id>/', views.super_admin_reject_sub_payment, name='super_admin_reject_sub_payment'),
    path('super-admin/hospitals/<int:hospital_id>/payments/', views.super_admin_hospital_payments, name='super_admin_hospital_payments'),
